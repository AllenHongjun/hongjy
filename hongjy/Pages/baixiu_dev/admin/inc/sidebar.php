<div class="aside">
  ...
  <ul class="nav">
    ...
    <?php 
     $post_menu_array= array('posts','post-add','categories');
     $is_active =in_array($current_page, $post_menu_array);;
    ?>
    <li  <?php echo $is_active  ? 'class="active"' : ''; ?>>
      <a href="#menu-posts" class="collapsed" data-toggle="collapse">
        <i class="fa fa-thumb-tack"></i>文章<i class="fa fa-angle-right"></i>
      </a>
      <ul id="menu-posts" class="collapse <?php echo $is_active  ? ' in' : ''; ?>">
    ...
    <?php 
    $settings_menu_array = array('nav-menus','slides','settings');

    $settings_is_active = in_array($current_page,$settings_menu_array);
     ?>
    <li <?php echo $settings_is_active ? 'class="active"' : '' ; ?>>
      <a href="#menu-settings" class="collapsed" data-toggle="collapse">
        <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
      </a>
      <ul id="menu-settings" class="collapse <?php echo $settings_is_active ? ' in' : '' ; ?>">
